...
namespace DAL
{
    class ClientTypeService
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(T_ClientType model)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@CT_Name", SqlDbType.VarChar,20),
                    new SqlParameter("@CT_Remark", SqlDbType.VarChar,100),
                    new SqlParameter("@CT_Safetyone", SqlDbType.VarChar,50),
                    new SqlParameter("@CT_Safetytwo", SqlDbType.VarChar,50),
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(T_ClientType model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_ClientType GetModel(int CT_ID)
        {
            ...
            T_ClientType model = new T_ClientType();
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_ClientType DataRowToModel(DataRow row)
        {
            Model.T_ClientType model = new T_ClientType();
            if (row != null)
            {
