...
namespace Model
{
	...
	/// </summary>
	[Serializable]
	public partial class T_BuyCancel
	{
		public T_BuyCancel()
		{}
		#region Model
		...
		private string _ca_stockid;
		private string _ca_stockname;
		private DateTime? _ca_date;
		private int? _ca_returnstatus;
		private int? _ca_auditstatus;
		...
		/// 供应商编号
		/// </summary>
		public string Ca_StockID
		{
			set{ _ca_stockid=value;}
			get{return _ca_stockid;}
		}
		/// <summary>
		/// 供应商名称
		/// </summary>
