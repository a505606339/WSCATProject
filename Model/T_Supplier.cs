...
namespace Model
{
	...
	public partial class T_Supplier
	{
		...
		private int? _su_bankaccounts;
		private string _su_bank;
		private string _su_profession;
		private string _su_procode;
		private string _su_credit;
		private decimal? _su_money=0M;
		private decimal? _su_surplus=0M;
		private int? _su_reckoning;
